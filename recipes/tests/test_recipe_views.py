...
class RecipeViewsTest( TestCase):
    ...
    def test_recipe_home_view_funcions_is_correct(self):
    ...
    def test_recipe_category_view_funcions_is_correct(self):
    ...
    def test_recipe_details_view_funcions_is_correct(self):
